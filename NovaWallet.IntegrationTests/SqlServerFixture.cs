...
public sealed class SqlServerFixture : IAsyncLifetime
{
    ...
    public async Task<LedgerApi> CreateApiAsync(long limit = 50_000_000)
    {
        ...
        var api = new LedgerApi(connection.ConnectionString, limit);
...
public sealed class LedgerApi(string connectionString, long limit) : WebApplicationFactory<Program>
{
    internal const string SigningKey = "Integration-tests-only-signing-key-1234567890";
    public TestClock Clock { get; } = new();
    public string ConnectionString => connectionString;
    public LedgerApi SecondInstance() => new(connectionString, limit);
    ...
    public HttpClient AuthenticatedClient()
    {
        ...
        var token = new JwtSecurityToken("NovaWallet.Tests", "NovaWallet.Tests", [new Claim("sub", "integration-actor")],
