...
$balance = Invoke-RestMethod "$BaseUrl/api/wallets/$($source.id)/balance" -Headers $headers
...
Write-Output "Smoke check passed: Swagger, JWT, create, credit, transfer, replay, balances and statement. Reference: $($transfer.reference)"
